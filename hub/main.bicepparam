...
param recoveryServiceVaultName = 'vault-moi-poc-qc-01'
param managedIdentityName = 'mi-kvaccess-moi-poc-qc-01'
param keyVaultName = 'kv-moi-poc-qc-01'
param keyVaultSKU = 'premium'
param applicationGatewayName = 'agw-moi-hub-qc-01'
param applicationGatewayPublicIPName = 'pip-agw-moi-hub-qc-01'
param appGatewayWAFPolicyName = 'wafpolicy-moi-hub-qc-01'
param vpnGatewayName = 'vgw-moi-hub-qc-01'
param vpnGatewayPublicIP = 'publicip-vgw-moi-hub-qc-01'
